...
import { CALL_STATUS_LABELS, CALL_STATUS_COLORS } from "@/lib/types";
...
export default function ListDetailPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <Link href="/lists" className="flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground mb-4">
      ...
      <div className="flex items-start justify-between mb-6">
        ...
        <div className="flex gap-2">
          <Link href={`/lists/${id}/add-contacts`}>
