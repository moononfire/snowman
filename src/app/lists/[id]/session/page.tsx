...
import { CALL_STATUS_LABELS, CALL_STATUS_COLORS, CALL_STATUS_ORDER, type CallStatus } from "@/lib/types";
    ...
    <div className="min-h-full bg-background">
      <div className="bg-card border-b border-border px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href={`/lists/${id}`} className="text-muted-foreground hover:text-foreground">
